...
<!--                     </div> -->
        ...
        <div class="content">
             ...
             <div class="first">
        <img src="/img/room.jpg" class="gift_box">Party Room
    </div>
    <div class="second">
        <div class="second2">TOTAL &nbsp;&nbsp;<span class=count1 id="count">0</span> &nbsp;&nbsp;ITEMS</div>
        <div class="second3"></div>
        <button id="Rprice_desc" class="highprice transparent-bg">HIGH PRICE</button>
        <button id="Rprice_asc"  class="lowprice transparent-bg">LOW PRICE</button>
    </div>
                ...
                <div class="item">
                    <div class="bottom">
                        <div class="image-container">
                            <img id="img" alt="${rooms.room_name}" src="${rooms.room_image}" width="350px" height="300px">
                            <div class="image-description">${rooms.room_name}<br>${rooms.room_price}원</div>
                        </div>
                    </div>
                    <div class="bottom2">${rooms.room_name}<br>${rooms.room_price}&nbsp;&nbsp;${rooms.howmany}명</div>
                </div>
            </div>
        </c:forEach>
    </div>
...
.on('click', '#Rprice_desc', function() {
       
    
    document.location = '/Rdescsort';
    return false;
})
.on('click', '#Rprice_asc', function() {
       
    
    document.location = '/Rascsort';
    return false;
})
////////////////////////////////////// 페이지네이션 코드 ///////////////////////////////////
