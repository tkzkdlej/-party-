...
<!--                     </div> -->
        ...
        <div class="content">
            ...
            <div class="content2">
                ...
                <h1 class=memberinquiry>회원 조회</h1>
               ...
               <caption>
                  <form action="" id="setRows">
                    ...
                    <tbody>
                       ...
                       <c:forEach items="${AM}" var="adminMem">
                        <tr><td>${adminMem.id}</td>
                        <td>${adminMem.pwd}</td>
                        <td>${adminMem.name}</td>
                        <td>${adminMem.email}</td>
                        <td>${adminMem.address}</td>
                        <td>${adminMem.zip_code}</td>
                        <td>${adminMem.mobile}</td>
                        <td>${fn:substring(adminMem.birth,0,10)}</td>
                        <td>${fn:substring(adminMem.regdate,0,10)}</td>
                        <td><input type="button" id="btnDel" name="${adminMem.id}" value="삭제"></td></tr>
                  </c:forEach>
                    </tbody>
                </table>
