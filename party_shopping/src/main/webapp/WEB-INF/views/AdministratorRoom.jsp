         ...
         <div class="content2">
            ...
            <table  name="tblRoom">
               ...
               <tbody id="tblRoom">
                  ...
                  <c:forEach items="${room}" var="adminRoom">
                     <tr>
                        <td>${adminRoom.room_num}</td>
                        <td>${adminRoom.room_name}</td>
                        <td>${adminRoom.howmany}</td>
                        <td>${adminRoom.room_price}</td>
                        <td><img src="${adminRoom.room_image}" alt="상품 이미지"
                           width=20px></td>
                     <tr>
                  </c:forEach>
               </tbody>
            ...
            <div class="button-container">
               <button type="button" id="btnNewRoom">상품 추가</button>
            </div>
...
// 상품등록
.on('click','#btnNewRoom',function(){
   document.location='/Administratorroomnew';
})
// 상품수정으로
.on('click','#tblRoom tr',function(){
   let a=$(this).find('td:eq(0)').text();
   document.location='/roomView/'+a;
})
